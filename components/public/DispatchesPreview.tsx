...
interface DispatchesPreviewProps {
  posts: Post[]
}
...
export function DispatchesPreview({ posts }: DispatchesPreviewProps) {
  if (posts.length === 0) return null

  return (
    <section aria-label="Latest Dispatches" className="bg-ink-soft py-20">
